...
extern "C" int64_t RUNTIME_EXPORT extract_month(const int64_t timeval);
extern "C" int64_t RUNTIME_EXPORT extract_day(const int64_t timeval);
extern "C" int64_t RUNTIME_EXPORT extract_hour(const int64_t timeval);
extern "C" int64_t RUNTIME_EXPORT extract_minute(const int64_t timeval);
extern "C" int64_t RUNTIME_EXPORT extract_second(const int64_t timeval);
extern "C" int32_t RUNTIME_EXPORT extract_month_fast(const int64_t timeval);
extern "C" int32_t RUNTIME_EXPORT extract_year_fast(const int64_t timeval);
